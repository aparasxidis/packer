...
profile="L2S L2W"
REC="vfat_filesystem_disabled_rec"
total_recommendations=$((total_recommendations+1))
runrec
...
RN="1.2.4"
RNA="Ensure Red Hat Subscription Manager connection is configured"
profile="L1S L1W"
REC="rh_ensure_subscription_manager_connection_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_bootloader_password"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed19_authentication_singleuser_mode"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="ensure_selinux_not_disabled_bootloader_configuration"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="nix_fed_ensure_mcstrans_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="rh_ensure_updates_patches_security_software_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_gdm_removed_or_login_banner_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
RN="2.2.2"
RNA="Ensure X11 Server components are not installed"
profile="L1S"
REC="fed_ensure_x11_server_components_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L2W"
REC="fed_ensure_avahi_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_dhcp_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ldap_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_nfs-utils_not_installed_or_nfs-server_service_masked"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_rpcbind_not_installed_or_rpcbind_services_masked"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_dns_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ftp_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_http_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_imap_pop3_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_samba_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_http_proxy_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_net-snmp_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_nis_server_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_rsh_client_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_talk_client_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ldap_client_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
#
RN="3.5.1.1"
RNA="Ensure FirewallD is installed"
profile="L1S L1W"
REC="fed_ensure_firewalld_installed"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.2"
RNA="Ensure iptables-services package is not installed"
profile="L1S L1W"
REC="fed_ensure_iptables-services_not_installed"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.3"
RNA="Ensure nftables is not installed or stopped and masked"
profile="L1S L1W"
REC="fed_ensure_nftables_not_installed_or_stopped_masked"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.4"
RNA="Ensure firewalld service is enabled and running"
profile="L1S L1W"
REC="fed_ensure_firewalld_service_enabled_running"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.5"
RNA="Ensure default zone is set"
profile="L1S L1W"
REC="fed_ensure_default_zone_set"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.6"
RNA="Ensure network interfaces are assigned to appropriate zone"
profile="L1S L1W"
REC="fed_ensure_interfaces_assigned_appropriate_zone"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.1.7"
RNA="Ensure unnecessary services and ports are not accepted"
profile="L1S L1W"
REC="fed_ensure_unnecessary_services_ports_not_accepted"
total_recommendations=$((total_recommendations+1))
runrec
...
RN="3.5.2.2"
RNA="Ensure firewalld is not installed or stopped and masked"
profile="L1S L1W"
REC="fed_ensure_firewalld_not_installed_or_stopped_masked"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_iptables_flushed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_base_chains_exists"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_loopback_traffic_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_outbound_established_connections_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_default_deny_firewall_policy"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_nftables_service_enabled"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_nftables_rules_permanent"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_iptables_packages_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_nftables_not_installed"
total_recommendations=$((total_recommendations+1))
runrec
...
RNA="Ensure default deny firewall policy"
profile="L1S L1W"
REC="fed_ensure_ipv4_default_deny_firewall_policy"
total_recommendations=$((total_recommendations+1))
runrec
...
RNA="Ensure loopback traffic is configured"
profile="L1S L1W"
REC="fed_ensure_ipv4_loopback_traffic_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
RNA="Ensure outbound and established connections are configured"
profile="L1S L1W"
REC="ensure_ipv4_outbound_and_established_connections_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ipv4_firewall_rules_exist_all_open_ports"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.3.2.5"
RNA="Ensure iptables rules are saved"
profile="L1S L1W"
REC="fed_ensure_iptables_rules_saved"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.3.2.6"
RNA="Ensure iptables is enabled and running"
profile="L1S L1W"
REC="fed_ensure_iptables_enabled_running"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ipv6_default_deny_firewall_policy"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ipv6_loopback_traffic_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="ensure_ipv6_outbound_and_established_connections_configured"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_ipv6_firewall_rules_exist_all_open_ports"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.3.3.5"
RNA="Ensure ip6tables rules are saved"
profile="L1S L1W"
REC="fed_ensure_ip6tables_rules_saved"
total_recommendations=$((total_recommendations+1))
runrec

RN="3.5.3.3.6"
RNA="Ensure ip6tables is enabled and running"
profile="L1S L1W"
REC="fed_ensure_ip6tables_enabled_running"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L2S L2W"
REC="fed19_ensure_login_logout_events_collected"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L2S L2W"
REC="ensure_system_administrator_actions_sudolog_collected"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed_ensure_rsyslog_installed"
total_recommendations=$((total_recommendations+1))
runrec

RN="4.2.1.2"
RNA="Ensure rsyslog Service is enabled and running"
profile="L1S L1W"
...
profile="L1S L1W"
REC="ensure_default_user_umask_027_more_restrictive"
total_recommendations=$((total_recommendations+1))
runrec
...
profile="L1S L1W"
REC="fed19_ensure_access_su_command_restricted"
total_recommendations=$((total_recommendations+1))
runrec
